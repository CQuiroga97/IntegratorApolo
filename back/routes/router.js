...
router.post("/getEliminatoriaParticipante", (req, res)=>{
    participante.getEliminatoriaParticipante(req, res, con);
})
...
router.post("/quemarIntegral", (req, res)=>{
    competencia.quemarIntegral(req, res, con);
})
