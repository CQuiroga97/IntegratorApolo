...
if(process.env.ENV == "Pruebas"){
  app.use('/images', express.static(path.join(__dirname, 'controllers/pruebas/integrales')));
  app.use('/integralesFinales', express.static(path.join(__dirname, 'controllers/pruebas/integralesFinales')));
}else{
